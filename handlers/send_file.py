    ...
    try:
        if Config.FORWARD_AS_COPY is True:
                ...
                await lazy_file.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("web Download", url=lazy_downloadd),  # we download Link
                                                        InlineKeyboardButton('▶Stream online', url=lazy_streamm)]])  # web stream Link
                )
                return await bot.copy_message(chat_id=user_id, from_chat_id=Config.DB_CHANNEL,
                                          ...
                                          reply_markup=InlineKeyboardMarkup(
                                            [
                                                [
                                                  InlineKeyboardButton("Fast Download", url=lazy_downloadd),
                                                  InlineKeyboardButton("▶Stream online", url=lazy_streamm),
                                                ],
                                            ]),
                                            )
