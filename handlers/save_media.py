...
async def save_batch_media_in_channel(bot: Client, editable: Message, message_ids: list):
    try:
        ...
        await editable.edit(
            f"**𝘉𝘢𝘵𝘤𝘩 𝘍𝘪𝘭𝘦𝘴 𝘚𝘵𝘰𝘳𝘦𝘥 𝘪𝘯 𝘮𝘺 𝘋𝘢𝘵𝘢𝘣𝘢𝘴𝘦!**\n\n𝙃𝙚𝙧𝙚 𝙞𝙨 𝙩𝙝𝙚 𝙋𝙚𝙧𝙢𝙖𝙣𝙚𝙣𝙩 𝙇𝙞𝙣𝙠 Button 𝙤𝙛 𝙮𝙤𝙪𝙧 𝙛𝙞𝙡𝙚𝙨 \n\n" #: {share_link}
            f"𝘑𝘶𝘴𝘵 𝘊𝘭𝘪𝘤𝘬 𝘵𝘩𝘦 share 𝘭𝘪𝘯𝘬 button 𝘵𝘰 𝘨𝘦𝘵 𝘺𝘰𝘶𝘳 𝘧𝘪𝘭𝘦𝘴!",
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("⚡️ Open Link ⚡️", url=share_link)]
                 #[InlineKeyboardButton("🔊Books Channel", url="https://t.me/ebookschannell"),
                #  InlineKeyboardButton("🍿support group", url="https://t.me/codeconvo")
                 ]
            ),
            disable_web_page_preview=True
        )
...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        await editable.edit(
            ...
            f"𝙃𝙚𝙧𝙚 𝙞𝙨 𝙩𝙝𝙚 𝙋𝙚𝙧𝙢𝙖𝙣𝙚𝙣𝙩 𝙇𝙞𝙣𝙠 𝙤𝙛 𝙮𝙤𝙪𝙧 𝙛𝙞𝙡𝙚  \n\n" #: {share_link}
            f"𝘊𝘭𝘪𝘤𝘬 𝘵𝘩𝘦 below button or hold it to copy the link 𝘵𝘰 𝘨𝘦𝘵 𝘺𝘰𝘶𝘳 𝘧𝘪𝘭𝘦...",
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("⚡️ Open Link ⚡️", url=share_link)],
                # [InlineKeyboardButton("🔊Books Channel", url="https://t.me/ebookschannell"),
                #  InlineKeyboardButton("🍿support group", url="https://t.me/codeconvo")
